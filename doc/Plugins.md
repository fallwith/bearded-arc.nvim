...
bearded-arc.nvim ships with highlight groups for 76 popular plugins and can auto-detect which ones you have installed.
...
- [arrow.nvim](https://github.com/otavioschwanck/arrow.nvim) — `arrow` — File bookmark menu with index numbers, current file, actions, and delete mode (5 groups)
...
- [LuaSnip](https://github.com/L3MON4D3/LuaSnip) — `luasnip` — Snippet engine node highlights for active, visited, insert, choice, dynamic, and restore nodes (11 groups)
...
- [oil-git-status.nvim](https://github.com/refractalize/oil-git-status.nvim) — `oil-git-status` — Git status signs in oil.nvim for index and working tree states (20 groups)
...
- [tiny-code-action.nvim](https://github.com/rachartier/tiny-code-action.nvim) — `tiny-code-action` — Code action kind highlights for quickfix, refactor, source, rename, and organize imports (10 groups)
